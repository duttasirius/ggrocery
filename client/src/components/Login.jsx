...
const Login = () => {
  ...
  setShowUserLogin(false);
    ...
    return (
      ...
      // when clicked outside login so that its hide the form  use onlcik
      <div onClick={()=>setShowUserLogin(false)} className="fixed top-0 bottom-0 left-0 right-0 flex items-center justify-center z-30 text-sm text-gray-600 bg-black/50">
          {/*  added e.stopPropagation so that its dosent effect child div  */}
